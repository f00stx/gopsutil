...
import (
	...
	"github.com/f00stx/gopsutil/process"
...
func HostIDWithContext(ctx context.Context) (string, error) {
	// there has been reports of issues on 32bit using golang.org/x/sys/windows/registry, see https://github.com/f00stx/gopsutil/pull/312#issuecomment-277422612
